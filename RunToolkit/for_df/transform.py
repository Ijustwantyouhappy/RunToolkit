...
from RunToolkit.utils import gen_logger
            ...
            if func is None:  # 1_1
                ...
                if isinstance(func, str):  # single function
                    if func == 'set':  # 1_2
                        ...
                        res = _match_1_common(df, keys, value, func, dropna, with_warnings, print_codes, df2dict_logger)
                    else:
                    ...
                    if func == ['len', 'set']:
                        ...
                        res = _match_1_nested_func_list_set(df, keys, value, with_warnings, print_codes, self.df2dict_logger)
                    else:
            ...
            if func is None:  # multi_1
                ...
                if isinstance(func, str):  # single function
                    if func == 'set':  # multi_2
                        ...
                        res = _match_multi_common(df, keys, value, func, with_warnings, print_codes, self.df2dict_logger)
                    else:
                        raise Exception("invalid func: {}".format(func))
                else:  # functions list
                    if func == ['len', 'set']:
